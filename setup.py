...
setup(name='ie_mbdbl2018_ahirane',
      ...
      long_description="""The package provides a function called linear_congruence_random_generator(), wich returns a random number based on the method of linear congruences using the following parameters:
a = 22695477
b = 1
m = 2**32
x0=1649836483
